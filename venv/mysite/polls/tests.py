...
class QuestionIndesxTests(TestCase):
    ...
    def test_past_question(self):
        """
            ...
            index page.
        """
        question = create_question(question_text="Past question.", days=-30) # 30일 전 데이터
        response = self.client.get(reverse('polls:index'))
    ...
    def test_future_question(self):
        ...
        self.assertQuerysetEqual(
            response.context['latest_question_liat'], []
        )
